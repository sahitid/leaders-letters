...
export default function HeadObject({children}) {
    const title = "Leaders Letters";
    const description = "      Letters from Hack Club Leaders";
    ...
    const keywords = "leaders letters, letters from leaders, hack club leaders, hack club leader letters";
